        ...
        <div className="container-page">
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-2">
            <Link to="/colors" className="group overflow-hidden rounded-lg border border-border bg-card">
              <img src={colorsImage} alt="Asian Paints products in the shop" className="aspect-[16/9] w-full object-cover" />
              <div className="p-4">
            ...
            <Link to="/materials" className="group overflow-hidden rounded-lg border border-border bg-card">
              <img src={materialsImage} alt="Furniture hardware and interior materials in the shop" className="aspect-[16/9] w-full object-cover" />
              <div className="p-4">
